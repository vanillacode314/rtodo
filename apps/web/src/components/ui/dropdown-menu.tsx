	...
	return (
		<DropdownMenuPrimitive.Portal>
			<DropdownMenuPrimitive.Content
				class={cn(
					'z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] animate-content-hide overflow-hidden border bg-popover text-popover-foreground shadow-md data-[expanded]:animate-content-show',
					props.class
				)}
				{...rest}
			/>
...
const DropdownMenuItem = <T extends ValidComponent = 'div'>(
	...
	return (
		<DropdownMenuPrimitive.Item
			class={cn(
				'relative flex cursor-default select-none items-center gap-2 px-2 py-1.5 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
				props.class
			)}
			{...rest}
		/>
...
const DropdownMenuSubContent = <T extends ValidComponent = 'div'>(
	...
	return (
		<DropdownMenuPrimitive.SubContent
			class={cn(
				'z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] overflow-hidden border bg-popover text-popover-foreground shadow-md animate-in',
				props.class
			)}
			{...rest}
		/>
